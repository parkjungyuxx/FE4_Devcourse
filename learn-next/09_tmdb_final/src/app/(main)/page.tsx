...
export default async function page() {
  return (
    <>
      ...
      <Suspense
        fallback={<MovieLoader subTitle="Now Movies" title="상영중인 영화" />}
      >
        <MainMovie
          type="now_playing"
          subTitle="Now Movies"
      ...
      <Suspense
        fallback={
          <MovieLoader subTitle="Popular Movies" title="인기있는 영화" />
        }
      >
        <MainMovie
          type="popular"
      ...
      <Suspense
        fallback={
          <MovieLoader subTitle="Upcoming Movies" title="개봉예정 영화" />
        }
      >
        <MainMovie
          type="upcoming"
